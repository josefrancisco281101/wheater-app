...
const Details = ({ selectedCity }) => {
  ...
  return (
    <>
      <div className="text-white pb-6 w-full h-[55%] text-center flex justify-between px-[50px]">
      ...
      <div className="text-white pb-6 w-full h-[45%] text-center flex justify-between px-[50px]">
        {/* Nueva sección para la visibilidad */}
        <div className="bg-[#1e213a] p-4 px-5 pb-8 w-[300px]">
          <h4>Visibility</h4>
          <div className="flex justify-center mt-2 items-center text-2xl">
            <div
        ...
        {/* Nueva sección para la presión de aire */}
        <div className="bg-[#1e213a] p-4 px-5 pb-8 w-[300px] ">
          <h4>Air Pressure</h4>
          <div className="flex justify-center mt-2 items-center text-2xl">
            <div
